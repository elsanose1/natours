...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/elsanose/clc2e1uk4006614oxd4xgpssk',
    // style URL
    scrollZoom: false,
    interactive: false
  });
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51LJhMFKbmdS908tj4RVR3Qo7OTVuPGc4o9ZSkaeqzNe8W5YR5EDeoO9NsdRqtmQWa13bf7ui8OCv5gZe1NDJM3Wv00Zuwst4Dh');
...
var settingForm = document.querySelector('#settingForm');
var passwordForm = document.querySelector('#passwordForm');
var logoutBtn = document.querySelector('.nav__el--logout');
var bookTourBtn = document.querySelector('#bookTour');
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 7;
            _context2.next = 10;
            return (0, _auth.register)(name, email, password, confirmPassword);
          case 10:
            _context2.next = 15;
            break;
          case 12:
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 10;
            return (0, _account.updateSettings)('data', form);
          case 10:
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 8;
            return (0, _account.updateSettings)('password', {
...
},{"./auth":"auth.js","./account":"account.js","./mapBox":"mapBox.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
